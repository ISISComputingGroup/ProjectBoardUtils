...
class GithubUtilsTests(unittest.TestCase):
    ...
    def test_GIVEN_PR_with_title_content_no_files_WHEN_get_info_called_THEN_return_title_and_content(
        self,
    ):
    ...
    def test_GIVEN_PR_with_title_content_and_file_changed_WHEN_get_info_called_with_filename_THEN_return_title_content_and_file_changes(
        self,
    ):
        expected_title = "TEST_TITLE"
        expected_content = "MY_CONTENT"
    ...
    def test_GIVEN_PR_with_title_content_and_file_changed_WHEN_get_info_called_with_different_filename_THEN_return_title_content_and_no_file_changes(
        self,
    ):
        expected_title = "TEST_TITLE"
        expected_content = "MY_CONTENT"
    ...
    def test_GIVEN_PR_with_url_to_ticket_in_code_WHEN_prs_checked_THEN_returns_true(self):
        pr_infos = [
            (
                "Bad title",
                "Some body text",
                "see https://github.com/ISISComputingGroup/IBEX/issues/1000",
            )
        ]
        self.assertTrue(ticket_mentioned_in_pr(1000, pr_infos))
